...
export default function Home() {
  return (
    <>
            ...
            <div className="lg:col-span-3">
              <div className="max-w-3xl">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                  Allow Brokers Mutual To Help You Choose The Right Loan
                </h1>

                <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                  Our comprehensive financial services are designed to assist
                  our clients, enhance borrowing capabilities, and secure the
                  best interest rates.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 ">
                  <a
                    href="/contact"
                    className="z-50 px-6 py-3 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition duration-300 text-center"
                  >
                    Schedule Consultation
                  </a>
                  <a
                    href="/404"
                    className="z-50 px-6 py-3 border border-slate-600 text-slate-200 font-medium rounded hover:border-blue-500 hover:text-blue-400 transition duration-300 text-center"
                  >
                    Explore Services
                  </a>
                </div>
              ...
              <div className="bg-slate-800 border border-slate-700 rounded-lg shadow-xl p-4 md:p-6">
                ...
                <div className="relative h-64">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-full">
                    ...
                    >
                      <path
                        d="M0,80 Q25,70 33,40 T50,35 T66,45 T75,30 T100,10"
                        stroke="rgb(37, 99, 235)"
                        strokeWidth="2"
                        fill="none"
                      />
                      <path
                        d="M0,80 Q25,70 33,40 T50,35 T66,45 T75,30 T100,10 V100 H0 Z"
                        fill="rgb(37, 99, 235)"
                        fillOpacity="0.1"
                      />
                    </svg>
                    ...
                    >
                      <path
                        d="M0,70 Q20,65 40,60 T60,55 T80,60 T100,50"
      ...
      {/* <!-- Services Section --> */}
      <section
        className="relative .bg-secondary-50 py-16 md:py-24 bg-white"
        id="services"
      >
        {/* <!-- Subtle grid pattern overlay --> */}
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-slate-600 leading-relaxed">
              Our tailored financial services are designed to optimize your
              wealth management strategy and drive sustainable growth for your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg overflow-hidden group">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-5">
                  Secure the right car loan for your needs with our expert
                  guidance and smart comparison tools designed to match your
                  budget, credit profile, and vehicle goals.
                </p>
                <div className="pt-4 border-t border-slate-100">
                  <a
                    href="#"
                    className="text-blue-600 font-medium text-sm flex items-center group-hover:translate-x-2 transition-transform duration-300"
                  >
                    Learn more
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg overflow-hidden group">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-5">
                  Drive your business forward with our tailored truck loan
                  solutions, competitive financing options, and long-term
                  support designed to keep you on the road.
                </p>
                <div className="pt-4 border-t border-slate-100">
                  <a
                    href="#"
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg overflow-hidden group">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-5">
                  Hit the road with confidence through our flexible motorbike
                  loan options, low-rate financing, and personalized support
                  built for your riding lifestyle.
                </p>
                <div className="pt-4 border-t border-slate-100">
                  <a
                    href="#"
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg overflow-hidden group">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-5">
                  Explore without limits with our tailored caravan loan
                  solutions, featuring competitive rates, flexible terms, and
                  expert guidance for your next great escape.
                </p>
                <div className="pt-4 border-t border-slate-100">
                  <a
                    href="#"
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg overflow-hidden group">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-5">
                  Set sail with ease using our customized boat loan options,
                  offering competitive rates, smooth approvals, and expert
                  support to get you on the water faster.
                </p>
                <div className="pt-4 border-t border-slate-100">
                  <a
                    href="#"
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg overflow-hidden group">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-5">
                  Make waves with our hassle-free jetski loan
                  solutions—featuring fast approvals, flexible terms, and great
                  rates tailored to your thrill-seeking lifestyle.
                </p>
                <div className="pt-4 border-t border-slate-100">
                  <a
                    href="#"
              ...
              <div className="grid md:grid-cols-2">
                <div className="p-8 md:p-10 flex flex-col justify-center">
                  <h3 className="text-2xl font-bold text-slate-800 mb-4">
                    Need to secure your loan fast?
                  </h3>
                  <p className="text-slate-600 mb-6">
                    Our team of expert financial advisors are ready to develop
                    and help you with your unique circumstances and goals.
                  </p>
                  <div>
                    <a
                      href="#"
                      className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded transition duration-300 shadow-md hover:shadow-lg z-50"
                    >
      ...
      <section className="relative py-16 md:py-24 bg-slate-50" id="features">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-5">
              Strategic Advantages with Brokers Mutual
            </h2>
            <p className="text-slate-600 leading-relaxed">
              Our comprehensive suite of lenders allows us to secure the best
              loan for your current financial needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg group z-10">
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  You have financial protection form the start, we only allow
                  our clients to borrow what they can afford. We are here for
                  your best interests.
                </p>
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg group z-10">
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Sophisticated methods to process interet rate data to deliver
                  actionable intelligence and forecast trends with precision
                  guided advise.
                </p>
                <div className="mt-5 pt-5 border-t border-slate-100">
                  <span className="text-blue-600 font-medium text-sm flex items-center group-hover:translate-x-2 transition-transform duration-300">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg group z-10">
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  All fees for the services we require will be transparently
                  communicated. There is no ambiguity about our pricing or
                  services. So you can be confident in your decision making
                </p>
                <div className="mt-5 pt-5 border-t border-slate-100">
                  <span className="text-blue-600 font-medium text-sm flex items-center group-hover:translate-x-2 transition-transform duration-300">
                    Learn more
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg group z-10">
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Financable is an integrated platform that allows us to
                  simplify the process of obtaining necessary data from our
                  clients to process their eligibility for a loan.
                </p>
                <div className="mt-5 pt-5 border-t border-slate-100">
                  <span className="text-blue-600 font-medium text-sm flex items-center group-hover:translate-x-2 transition-transform duration-300">
                    Learn more
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg group z-10">
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Gain access to certified financial advisors with
                  sector-specific expertise who provide personalised assistance
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-md transition duration-300 hover:shadow-lg group z-10">
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Leverage off our lenders, we have mutiple options and are
                  connected with mutiple lenders all over Australia, which means
                  you have options when selecting your loan.
                </p>
                <div className="mt-5 pt-5 border-t border-slate-100">
                  <span className="text-blue-600 font-medium text-sm flex items-center group-hover:translate-x-2 transition-transform duration-300">
                    Learn more
          ...
          <div className="mt-16 bg-gradient-to-r from-slate-800 to-slate-900 rounded-lg shadow-xl overflow-hidden">
            <div className="relative p-8 md:p-10">
              ...
              <div className="absolute top-0 right-0 w-1/2 h-full opacity-10">
                ...
                >
                  <path
                    d="M39.3,-68.1C52.1,-64.5,64.7,-55.8,73.2,-43.8C81.8,-31.8,86.3,-15.9,83.9,-1.4C81.5,13.1,72.2,26.2,61.9,36.6C51.6,46.9,39.2,54.5,26.7,59.6C14.2,64.7,1.5,67.1,-12.8,68.4C-27.1,69.7,-42.1,69.9,-53,63.3C-63.9,56.7,-70.7,43.3,-73.4,29.5C-76.1,15.8,-74.7,1.7,-71.8,-11.5C-68.9,-24.6,-64.4,-36.8,-56,-48.3C-47.6,-59.8,-35.3,-70.5,-21.9,-73.1C-8.6,-75.7,5.8,-70.1,19.7,-66C33.6,-61.9,46.9,-59.2,59.7,-51.9Z"
              ...
              <div className="md:flex items-center justify-between relative z-10">
                <div className="md:w-2/3 mb-6 md:mb-0">
                  <h3 className="text-2xl font-bold text-white mb-2">
                    Ready to secure your next loan?
                  </h3>
                ...
                <div>
                  <a
                    href="/contact"
                    className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded transition duration-300"
                  >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-secondary-600 max-w-2xl mx-auto">
              Hear from people who have transformed their financial future with
              Brokers Mutual.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="testimonial-slide active bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              <div className="text-lg text-secondary-700 mb-6 relative">
                ...
                Had the best experience with Stewart who organised my car in
                less than 3 days, with the best repayment schedule. It was
                probably the best experience I have had ever in making a
                purchase. Highly recommend them. Very quick, very straight
                forward and keeps you in the loop throughout the whole process.
            ...
            <div className="testimonial-slide bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              <div className="text-lg text-secondary-700 mb-6 relative">
                ...
                Stewart was extremely helpful, got our loan approved throughly
                quickly and we most definitely recommend him for your finance.
                <span className="absolute -bottom-4 -right-4 text-primary-400 text-4xl opacity-50">
                  &quot;
                </span>
              </div>
            ...
            <div className="testimonial-slide bg-white p-8 rounded-xl shadow-lg border border-gray-100">
              <div className="text-lg text-secondary-700 mb-6 relative">
                ...
                Stewart was absolutely amazing when I came to him for some auto
                finance. He is super fast a reliable. Had me driving out within
                same day.
                <span className="absolute -bottom-4 -right-4 text-primary-400 text-4xl opacity-50">
                  &quot;
                </span>
            ...
            <div className="flex justify-center mt-8 space-x-2">
              <button
                className="slider-dot w-3 h-3 rounded-full bg-gray-300 active bg-primary-600"
                data-slide="0"
              ></button>
              <button
                className="slider-dot w-3 h-3 rounded-full bg-gray-300"
                data-slide="1"
              ></button>
              <button
                className="slider-dot w-3 h-3 rounded-full bg-gray-300"
      ...
      <section className="cta-bg text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg max-w-3xl mx-auto mb-10 text-secondary-200">
            Join thousands of satisfied clients who are already with Brokers
            Mutual.
          </p>
